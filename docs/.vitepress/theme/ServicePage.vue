  ...
  <div class="wbx-service">
    ...
    <section class="wbx-service-section wbx-service-rules" aria-labelledby="service-rules-title">
      ...
      <dl>
        ...
        <div>
          <dt>退款</dt>
          <dd>服务方在诊断开始前确认需求明显不适合承接时，可原路退还诊断费；诊断开始或完成后不退款。</dd>
        </div>
        <div>
          <dt>改期与迟到</dt>
          <dd>需要改期时，请至少在约定时间前 24 小时提出；迟到不延长结束时间，超过 15 分钟视为放弃当次服务。</dd>
        </div>
        <div>
          <dt>项目抵扣</dt>
          <dd>诊断完成后 7 个自然日内确认同一需求并支付后续项目首款，¥399 可全额抵扣项目费用。</dd>
        </div>
        <div>
          <dt>资料与隐私</dt>
