...
![](/article-assets/source-calibration/ch19/001.png)
...
![](/article-assets/source-calibration/ch19/002.png)

## 如何召唤：从一句话开始，但不要停在一句话

![](/article-assets/source-calibration/ch19/003.png)
...
![](/article-assets/source-calibration/ch19/004.png)
...
![](/article-assets/source-calibration/ch19/008.png)
...
![](/article-assets/source-calibration/ch19/009.png)

![](/article-assets/source-calibration/ch19/010.png)

成片验收不要只看“能不能播放”。至少检查旁白与字幕是否一致、镜头时长是否匹配、文字是否遮挡主体、BGM 是否可用、素材是否有版权风险、画面是否适合目标平台安全区。

### 生成流程四：发布可以自动化，但默认要人工确认

发布 Agent 自动生成标题、自动打标签、自动上传封面，并通过云手机发布到抖音、视频号和 B 站。这是很强的自动化能力，但白皮书建议默认不要直接自动发布，除非账号、素材、标题和合规边界都已经过人工确认。

![](/article-assets/source-calibration/ch19/011.png)

![](/article-assets/source-calibration/ch19/012.png)
...
![](/article-assets/source-calibration/ch19/013.png)

![](/article-assets/source-calibration/ch19/014.png)
...
![](/article-assets/source-calibration/ch19/015.png)
...
![](/article-assets/source-calibration/ch19/016.png)

![](/article-assets/source-calibration/ch19/017.png)

### 拆解流程三：视频理解与镜头语言分析

接下来是最有意思的一步：视频理解。小淼会分析整条视频的景别、运镜、转场、剪辑节奏、色调、镜头时长。很多看起来“有感觉”的爆款视频，背后其实有稳定的镜头规律。

![](/article-assets/source-calibration/ch19/018.png)

![](/article-assets/source-calibration/ch19/019.png)
